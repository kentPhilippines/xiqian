				...
				<tr>
					...
					<td>
						...
						<c:if test="${!empty p.firstProductImage}">
							<img width="40px" src="/images/productSingle/${p.firstProductImage.id}.jpg">
						</c:if>
					...
					<td><a href="#?pid=${p.id}" class ="attribute"><span
							class="glyphicon glyphicon-th-list"></span></a></td><!-- 产品尺寸管理  -->
