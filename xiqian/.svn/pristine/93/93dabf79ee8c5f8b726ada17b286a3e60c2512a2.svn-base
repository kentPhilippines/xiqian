						...
						<c:forEach items="${pisSingle}" var="pi">
							<tr>
								...
								<td>
									...
									<a title="点击查看原图" href="/images/productSingle/${pi.id}.jpg"><img height="50px" src="/images/productSingle/${pi.id}.jpg"></a>
								</td>
					...
					<table class="table table-striped table-bordered table-hover  table-condensed">
						...
						<c:forEach items="${pisDetail}" var="pi">
							<tr>
								<td>${pi.id}</td>
								<td>
									<a title="点击查看原图" href="/images/productDetail/${pi.id}.jpg"><img height="50px" src="/images/productDetail/${pi.id}.jpg"></a>
								</td>
								<td><a deleteLink="true"
									   href="admin_productImage_delete?id=${pi.id}"><span
										class=" 	glyphicon glyphicon-trash"></span></a></td>
