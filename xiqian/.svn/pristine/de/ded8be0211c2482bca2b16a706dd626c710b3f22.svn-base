...
public class Encryption extends Params{
	/**
	 * 加密方法
	 * 
	 * @param strSrc
	 ...
	 * @throws Exception
	 */
	public static String encryptDataUTF8(String encryptdata, String encryptkey)
			throws Exception {
		try{
			DESPlus desPlus = new DESPlus(encryptkey);
			return desPlus.encryptUTF(encryptdata);
		}catch(Exception e){
			e.printStackTrace();
		}
		return "";
	 ...
	 * @throws Exception
	 */
	public static String decryptDataUTF8(String decryptdata, String decryptkey)
			throws Exception {
		DESPlus desPlus = new DESPlus(decryptkey);
	...
	public static void main(String[] args)
	{
		try {
			String str = "111";
			String deskey = "1";
			String ecodestr = Encryption.encryptDataUTF8(str,deskey);
			System.out.println("加密后："+ecodestr);
			String dencodestr = Encryption.decryptDataUTF8(ecodestr, deskey);
			System.out.println("解密后："+dencodestr);
		} catch (Exception e) {
			e.printStackTrace();
		}
